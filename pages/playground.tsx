        ...
        <main className="min-h-screen bg-slate-50">
          ...
          <section className="p-8">
            ...
            <Modal isOpen={isModalOpen} setIsOpen={setIsModalOpen}>
              ...
              <div className="mt-4">
                <button
                  className="inline-flex justify-center rounded-md border border-transparent bg-blue-100 px-4 py-2 text-sm font-medium text-blue-900 hover:bg-blue-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2"
