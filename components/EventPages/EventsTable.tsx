    ...
    <div className="w-full overflow-x-auto ">
      <table className="table w-full ">
        ...
        <tbody>
          ...
          {data.map((data, index) => (
            <tr key={index}>
              <td className="text-gray-700">Reg no.</td>
              <td className="text-gray-700">Event Name</td>

              <td className="text-gray-700">{data?.startDate}</td>
              <td className="text-gray-700">no. of attendees</td>
